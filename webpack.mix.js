...
// Page list
const page_styles = ["base", "default", "template-home", "template-catalog", "template-material", "template-material-shop", "template-product", "template-cart", "template-registration", "template-checkout"];
